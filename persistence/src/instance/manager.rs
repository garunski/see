...
impl InstanceManager {
    ...
    pub async fn create_workflow(&self, mut workflow: Workflow) -> Result<(), PersistenceError> {
        debug!(
            "Creating workflow for instance {}: {}",
            self.instance_id, workflow.name
        );
    ...
    pub async fn get_workflows_for_instance(&self) -> Result<Vec<Workflow>, PersistenceError> {
        ...
        self.workflow_store
            .list_by_instance(&self.instance_id, 1000, 0)
            .await
    }
    ...
    pub async fn create_workflow_execution(
        ...
        debug!(
            "Creating workflow execution for instance {}: {}",
    ...
    pub async fn get_workflow_executions_for_instance(
        &self,
    ) -> Result<Vec<WorkflowExecution>, PersistenceError> {
        debug!(
            "Getting workflow executions for instance: {}",
            self.instance_id
        );
    ...
    pub async fn get_all_workflow_executions(
        &self,
    ) -> Result<Vec<WorkflowExecution>, PersistenceError> {
    ...
    pub async fn create_task_execution(
        ...
        debug!(
            "Creating task execution for instance {}: {}",
            self.instance_id, task.id
        );
    ...
    pub async fn get_tasks_for_workflow_execution(
        &self,
        workflow_execution_id: &str,
    ) -> Result<Vec<TaskExecution>, PersistenceError> {
        debug!(
            "Getting tasks for workflow execution: {}",
            workflow_execution_id
        );
        self.task_execution_store
            .list_by_workflow_execution(workflow_execution_id)
            .await
    }
    ...
    pub async fn create_user_prompt(&self, mut prompt: UserPrompt) -> Result<(), PersistenceError> {
        debug!(
            "Creating user prompt for instance {}: {}",
            self.instance_id, prompt.name
        );
    ...
    pub async fn get_user_prompts_for_instance(&self) -> Result<Vec<UserPrompt>, PersistenceError> {
        ...
        self.user_prompt_store
            .list_by_instance(&self.instance_id)
            .await
    }
    ...
    pub async fn create_ai_prompt(&self, mut prompt: AiPrompt) -> Result<(), PersistenceError> {
        debug!(
            "Creating AI prompt for instance {}: {}",
            self.instance_id, prompt.name
        );
    ...
    pub async fn create_setting(&self, mut setting: Setting) -> Result<(), PersistenceError> {
        debug!(
            "Creating setting for instance {}: {}",
            self.instance_id, setting.key
        );
