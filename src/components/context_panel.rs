        ...
        div {
            ...
            button {
                ...
                div {
                    ...
                    class: if show_context { "rotate-180" } else { "" },
                    "▼"
                }
            }
            if show_context {
                div {
                    ...
                    div {
                        class: "bg-zinc-50 dark:bg-zinc-950 p-6",
                        pre {
                            class: "text-sm text-zinc-950 dark:text-zinc-100 whitespace-pre-wrap overflow-x-auto font-mono",
                    ...
                    div {
                        ...
                        button {
                            class: "px-4 py-2 bg-purple-500/20 hover:bg-purple-500/30 text-purple-600 dark:text-purple-400 rounded-xl text-sm font-medium transition-colors duration-200 border border-purple-500/30",
