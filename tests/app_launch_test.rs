...
// Test that the App component can be launched and rendered
#[test]
fn test_app_launches_successfully() {
    // Test that the main App component structure is correct
...
#[test]
fn test_app_has_visible_ui_elements() {
    // Test that the app has all the necessary UI elements that should be visible
    let rendered = render_element(rsx! {
        div {
            ...
            div {
                ...
                aside {
                    ...
                    div {
                        ...
                        button {
                            class: "flex w-full items-center gap-3 rounded-lg px-2 py-2.5 text-left text-base/6 font-medium text-zinc-950",
                            div {
                                class: "w-5 h-5",
                                "☀️"
                            }
                    ...
                    div {
                        class: "p-4",
                        label {
                            class: "mb-1 px-2 text-xs/6 font-medium text-zinc-500",
                            "Workflow File"
                        }
                        input {
                            class: "w-full px-3 py-2 bg-white border border-zinc-300 rounded-lg text-zinc-950 placeholder-zinc-500",
                            r#type: "text",
                            placeholder: "Select workflow file...",
                            value: "workflow.json",
                        }
                        button {
                            class: "relative isolate inline-flex items-baseline justify-center gap-x-2 rounded-lg border text-base/6 font-semibold px-3 py-2 text-zinc-950",
                            div {
                                class: "w-5 h-5",
                                "📁"
                            }
                    ...
                    div {
                        class: "p-4",
                        button {
                            class: "relative isolate inline-flex items-baseline justify-center gap-x-2 rounded-lg border text-base/6 font-semibold px-3 py-2 text-white bg-emerald-600",
                            div {
                                class: "w-5 h-5",
                                "🚀"
                            }
                ...
                main {
                    ...
                    div {
                        ...
                        div {
                            class: "mx-auto max-w-6xl",
                            h2 {
                                class: "text-2xl font-bold text-zinc-950 mb-6",
                                "Welcome to Workflow Executor"
                            }
                            p {
